    ...
    class Accompaniment
    {
        ...
        public static void Initialize()
        {
            ...
            */
            ...
            availablePatterns.Add(new Pattern("Mountain0121-2101", "산0121-2101", score, 32, 1));

            score = new Score();
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 0, 0, 7);
            score.AddNote(() => Music.chord.GetNote(2, 0), 1, 0, 1, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 0, 2, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 0, 3, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 0, 4, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 0, 5, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 0, 6, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 0, 7, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 0, 8, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 0, 9, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 0, 10, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 0, 11, 7);
            score.AddNote(() => Music.chord.GetNote(0, 4), 1, 0, 12, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 0, 13, 7);
            score.AddNote(() => Music.chord.GetNote(1, 4), 1, 0, 14, 7);
            score.AddNote(() => Music.chord.GetNote(2, 4), 1, 0, 15, 7);
            score.AddNote(() => Music.chord.GetNote(2, 4), 1, 1, 0, 7);
            score.AddNote(() => Music.chord.GetNote(0, 4), 1, 1, 1, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 1, 2, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 1, 3, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 1, 4, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 1, 5, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 1, 6, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 1, 7, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 1, 8, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 1, 9, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 1, 10, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 1, 11, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 1, 12, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 1, 13, 7);
            score.AddNote(() => Music.chord.GetNote(2, 0), 1, 1, 14, 7);
            score.AddNote(() => Music.chord.GetNote(1, 0), 1, 1, 15, 7);
            availablePatterns.Add(new Pattern("Mountain0212-2021", "산0212-2021", score, 32, 1));
            
            score = new Score();
            score.AddNote(() => Music.chord.GetNote(1, 0), 1, 0, 0, 7);
            score.AddNote(() => Music.chord.GetNote(2, 0), 1, 0, 1, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 0, 2, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 0, 3, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 0, 4, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 0, 5, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 0, 6, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 0, 7, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 0, 8, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 0, 9, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 0, 10, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 0, 11, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 0, 12, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 0, 13, 7);
            score.AddNote(() => Music.chord.GetNote(0, 4), 1, 0, 14, 7);
            score.AddNote(() => Music.chord.GetNote(2, 4), 1, 0, 15, 7);
            score.AddNote(() => Music.chord.GetNote(0, 5), 1, 1, 0, 7);
            score.AddNote(() => Music.chord.GetNote(2, 4), 1, 1, 1, 7);
            score.AddNote(() => Music.chord.GetNote(1, 4), 1, 1, 2, 7);
            score.AddNote(() => Music.chord.GetNote(3, 3), 1, 1, 3, 7);
            score.AddNote(() => Music.chord.GetNote(0, 4), 1, 1, 4, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 1, 5, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 1, 6, 7);
            score.AddNote(() => Music.chord.GetNote(3, 2), 1, 1, 7, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 1, 8, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 1, 9, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 1, 10, 7);
            score.AddNote(() => Music.chord.GetNote(3, 1), 1, 1, 11, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 1, 12, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 1, 13, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 1, 14, 7);
            score.AddNote(() => Music.chord.GetNote(3, 0), 1, 1, 15, 7);
            availablePatterns.Add(new Pattern("Mountain1202-0213", "산1202-0213", score, 32, 1));

            score = new Score();
            score.AddNote(() => Music.chord.GetNote(3, 0), 1, 0, 0, 7);
            score.AddNote(() => Music.chord.GetNote(2, 0), 1, 0, 1, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 0, 2, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 0, 3, 7);
            score.AddNote(() => Music.chord.GetNote(3, 1), 1, 0, 4, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 0, 5, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 0, 6, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 0, 7, 7);
            score.AddNote(() => Music.chord.GetNote(3, 2), 1, 0, 8, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 0, 9, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 0, 10, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 0, 11, 7);
            score.AddNote(() => Music.chord.GetNote(3, 3), 1, 0, 12, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 0, 13, 7);
            score.AddNote(() => Music.chord.GetNote(0, 4), 1, 0, 14, 7);
            score.AddNote(() => Music.chord.GetNote(1, 4), 1, 0, 15, 7);
            score.AddNote(() => Music.chord.GetNote(2, 4), 1, 1, 0, 7);
            score.AddNote(() => Music.chord.GetNote(0, 4), 1, 1, 1, 7);
            score.AddNote(() => Music.chord.GetNote(3, 3), 1, 1, 2, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 1, 3, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 1, 4, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 1, 5, 7);
            score.AddNote(() => Music.chord.GetNote(3, 2), 1, 1, 6, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 1, 7, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 1, 8, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 1, 9, 7);
            score.AddNote(() => Music.chord.GetNote(3, 1), 1, 1, 10, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 1, 11, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 1, 12, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 1, 13, 7);
            score.AddNote(() => Music.chord.GetNote(3, 0), 1, 1, 14, 7);
            score.AddNote(() => Music.chord.GetNote(1, 0), 1, 1, 15, 7);
            availablePatterns.Add(new Pattern("Mountain3201-2031", "산3201-2031", score, 32, 1));

            score = new Score();
            score.AddNote(() => Music.chord.GetNote(1, 0), 1, 0, 0, 7);
            score.AddNote(() => Music.chord.GetNote(0, 0), 1, 0, 1, 7);
            score.AddNote(() => Music.chord.GetNote(2, 0), 1, 0, 2, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 0, 3, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 0, 4, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 0, 5, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 0, 6, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 0, 7, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 0, 8, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 0, 9, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 0, 10, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 0, 11, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 0, 12, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 0, 13, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 0, 14, 7);
            score.AddNote(() => Music.chord.GetNote(0, 4), 1, 0, 15, 7);
            score.AddNote(() => Music.chord.GetNote(1, 4), 1, 1, 0, 7);
            score.AddNote(() => Music.chord.GetNote(0, 4), 1, 1, 1, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 1, 2, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 1, 3, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 1, 4, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 1, 5, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 1, 6, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 1, 7, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 1, 8, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 1, 9, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 1, 10, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 1, 11, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 1, 12, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 1, 13, 7);
            score.AddNote(() => Music.chord.GetNote(2, 0), 1, 1, 14, 7);
            score.AddNote(() => Music.chord.GetNote(0, 0), 1, 1, 15, 7);
            availablePatterns.Add(new Pattern("Mountain1020-1020", "산1020-1020", score, 32, 1));

            score = new Score();
            score.AddNote(() => Music.chord.GetNote(0, 0), 1, 0, 0, 7);
            score.AddNote(() => Music.chord.GetNote(1, 0), 1, 0, 1, 7);
            score.AddNote(() => Music.chord.GetNote(2, 0), 1, 0, 2, 7);
            score.AddNote(() => Music.chord.GetNote(3, 0), 1, 0, 3, 7);
            score.AddNote(() => Music.chord.GetNote(0, 1), 1, 0, 4, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 0, 5, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 0, 6, 7);
            score.AddNote(() => Music.chord.GetNote(3, 1), 1, 0, 7, 7);
            score.AddNote(() => Music.chord.GetNote(0, 2), 1, 0, 8, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 0, 9, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 0, 10, 7);
            score.AddNote(() => Music.chord.GetNote(3, 2), 1, 0, 11, 7);
            score.AddNote(() => Music.chord.GetNote(0, 3), 1, 0, 12, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 0, 13, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 0, 14, 7);
            score.AddNote(() => Music.chord.GetNote(3, 3), 1, 0, 15, 7);
            score.AddNote(() => Music.chord.GetNote(1, 4), 1, 1, 0, 7);
            score.AddNote(() => Music.chord.GetNote(3, 3), 1, 1, 1, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 1, 2, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 1, 3, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 1, 4, 7);
            score.AddNote(() => Music.chord.GetNote(3, 2), 1, 1, 5, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 1, 6, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 1, 7, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 1, 8, 7);
            score.AddNote(() => Music.chord.GetNote(3, 1), 1, 1, 9, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 1, 10, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 1, 11, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 1, 12, 7);
            score.AddNote(() => Music.chord.GetNote(3, 0), 1, 1, 13, 7);
            score.AddNote(() => Music.chord.GetNote(1, 0), 1, 1, 14, 7);
            score.AddNote(() => Music.chord.GetNote(2, 0), 1, 1, 15, 7);
            availablePatterns.Add(new Pattern("Mountain0123-1312", "산0123-1312", score, 32, 1));
            ...
            score.AddNote(() => Music.chord.GetNote(1, 4), 1, 1, 1, 7);
            score.AddNote(() => Music.chord.GetNote(3, 3), 1, 1, 2, 7);
            score.AddNote(() => Music.chord.GetNote(1, 4), 1, 1, 3, 7);
            score.AddNote(() => Music.chord.GetNote(2, 3), 1, 1, 4, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 1, 5, 7);
            score.AddNote(() => Music.chord.GetNote(3, 2), 1, 1, 6, 7);
            score.AddNote(() => Music.chord.GetNote(1, 3), 1, 1, 7, 7);
            score.AddNote(() => Music.chord.GetNote(2, 2), 1, 1, 8, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 1, 9, 7);
            score.AddNote(() => Music.chord.GetNote(3, 1), 1, 1, 10, 7);
            score.AddNote(() => Music.chord.GetNote(1, 2), 1, 1, 11, 7);
            score.AddNote(() => Music.chord.GetNote(2, 1), 1, 1, 12, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 1, 13, 7);
            score.AddNote(() => Music.chord.GetNote(3, 0), 1, 1, 14, 7);
            score.AddNote(() => Music.chord.GetNote(1, 1), 1, 1, 15, 7);
            availablePatterns.Add(new Pattern("Mountain0202-2131", "산0202-2131", score, 32, 1));
